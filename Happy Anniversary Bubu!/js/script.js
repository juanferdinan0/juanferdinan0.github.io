...
//随机文字烟花内容
const randomWords = ["Happy Anniversary, Bubu!"];
const wordDotsMap = {};
...
const helpContent = {
	shellType: {
		header: "Jenis kembang api",
		body: "Untuk jenis kembang api yang ingin Anda nyalakan, pilih (Acak) untuk pengalaman yang luar biasa! ",
	},
	shellSize: {
		header: "Ukuran kembang api",
		body: "Semakin besar kembang api, semakin luas jangkauan mekarnya, namun semakin besar kembang api, semakin besar performa yang dibutuhkan oleh perangkat. Kembang api besar dapat menyebabkan perangkat Anda freezing. ",
	},
	quality: {
		header: "Kualitas gambar",
		body: "Jika animasi tidak berjalan lancar, Anda bisa mencoba menurunkan kualitas gambar. Semakin tinggi kualitas gambar, semakin besar jumlah percikan api setelah kembang api meledak, namun kualitas gambar yang tinggi dapat menyebabkan perangkat Anda terhenti. ",
	},
	skyLighting: {
		header: "Menerangi langit",
		body: "Saat kembang api meledak, latar belakang akan menyala. Jika layar Anda tampak terlalu terang, ubah ke (Gelap) atau (Tidak). ",
	},
	scaleFactor: {
		header: "Perbesar",
		body: "Membawa Anda lebih dekat atau lebih jauh dari kembang api. Untuk kembang api yang lebih besar, Anda dapat memilih nilai zoom yang lebih kecil, terutama pada ponsel atau tablet. ",
	},
	wordShell: {
		header: "Teks kembang api",
		body: "Saat dihidupkan, akan muncul teks berbentuk kembang api. Misalnya: Selamat Tahun Baru, semua keinginan Anda terkabul, dll. ",
	},
	autoLaunch: {
		header: "Otomatis nyalakan kembang api",
		body: "Setelah menyalakannya, Anda dapat duduk di depan layar perangkat Anda dan menikmati kembang api. Anda juga dapat mematikannya, namun setelah mematikannya, Anda hanya dapat menyalakan kembang api dengan mengetuk layar. ",
	},
	finaleMode: {
		header: "Nyalakan lebih banyak kembang api secara bersamaan",
		body: "Anda dapat secara otomatis melepaskan lebih banyak kembang api secara bersamaan (tetapi Anda harus mengaktifkan (Otomatis nyalakan kembang api) terlebih dahulu). ",
	},
	hideControls: {
		header: "Sembunyikan tombol pengaturan",
		body: "Sembunyikan tombol di bagian atas layar. Jika Anda ingin mengambil tangkapan layar, atau membutuhkan pengalaman yang mulus, Anda dapat menyembunyikan tombol tersebut. Setelah menyembunyikan tombol tersebut, Anda masih dapat membuka pengaturan di pojok kanan atas. ",
	},
	fullscreen: {
		header: "Layar penuh",
		body: "Beralih ke mode layar penuh. ",
	},
	longExposure: {
		header: "Pertahankan percikan kembang api",
		body: "Dapat mempertahankan percikan api yang ditinggalkan oleh kembang api. ",
	},
};
...
function init() {
	...
	setOptionsForSelect(appNodes.quality, [
		{ label: "Rendah", value: QUALITY_LOW },
		{ label: "Normal", value: QUALITY_NORMAL },
		{ label: "Tinggi", value: QUALITY_HIGH },
	]);

	setOptionsForSelect(appNodes.skyLighting, [
		{ label: "Tidak", value: SKY_LIGHT_NONE },
		{ label: "Gelap", value: SKY_LIGHT_DIM },
...
if (IS_HEADER) {
	...
	setLoadingStatus("Mohon tunggu sebentar");
	setTimeout(() => {
		// 只加载 soundManager
